...
const ProjectCard = ({ title, description, image, tech, demo }: ProjectCardProps) => {
  ...
  return (
    ...
    >
        ...
        <div className="p-4 lg:p-8 flex-1 flex flex-col relative z-10">
          <h3 
            className="text-xl md:text-2xl lg:text-3xl font-bold mb-4 text-white group-hover:text-[var(--neon-blue)] transition-colors duration-300 leading-tight group-hover:translate-x-2"
          >
            {title}
          </h3>
